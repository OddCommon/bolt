...
class BoltRouter extends Eventful {
    ...
    async _render(html){
        ...
        const oldPageLinks = [...document.querySelectorAll('link')].filter((l) => l.rel == "modulepreload" );
        ...
        const newPageLinks = [...newPage.querySelectorAll('link')].filter((l) => l.rel == "modulepreload" );;
...
export default window.BoltRouter;